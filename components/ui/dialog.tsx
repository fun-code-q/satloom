  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          // w-[calc(100%-2rem)] rather than w-full: with w-full the dialog
          // spans the viewport edge-to-edge on phones, so the close button
          // (right-3, plus its focus ring) sat past the right edge — the audit
          // measured it 3px outside on every phone width. It also leaves the
          // card visually cramped against both edges.
          // max-h + overflow-y-auto keeps a tall dialog's own content, and its
          // action buttons, on screen instead of overflowing the viewport.
          "fixed left-[50%] top-[50%] z-[1100] grid w-[calc(100%-2rem)] max-w-md max-h-[90dvh] overflow-y-auto translate-x-[-50%] translate-y-[-50%] gap-4 border bg-slate-800 p-6 shadow-2xl duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] rounded-2xl",
          className
        )}

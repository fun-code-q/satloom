...
export interface ButtonProps
  ...
  asChild?: boolean
  variant?: "default" | "destructive" | "outline" | "secondary" | "ghost" | "link" | null | any
  size?: "default" | "sm" | "lg" | "icon" | null | any
  haptic?: boolean
}

const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, haptic = true, ...props }, ref) => {

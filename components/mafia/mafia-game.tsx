...
export function MafiaGame({ config, roomId, userId, userName, isHost, onClose }: MafiaGameProps) {
    ...
    if (!session) {
        return (
            <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[510]">
    ...
    return (
        <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-[510] p-4">
